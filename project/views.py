...
class BaseView(TemplateView):
    template_name = 'project/base.html' # use base template
...
class ShowUserDashboardView(TemplateView):
    ...
    template_name = 'project/user_dashboard.html' # Use the user dashboard template
...
class CreateProfileView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'project/create_profile_form.html' # show create_profile_form template
...
class ShowProfilePageView(CollaboratorContextMixin, DetailView):
    ...
    model = Profile # retrieve objects of type Profile from the database
    template_name = 'project/show_profile.html' # show_profile_page template
    context_object_name = 'profile' # how to find the data in the template file
    def get_object(self, queryset=None):
...
class LogoutRedirectView(TemplateView):
    ...
    template_name = 'project/logged_out.html' ## show the logged_out template 
...
class UserRegistrationView(CreateView):
    ...
    template_name = 'project/register.html' # show the register template
...
class ShowEventDetailsView(LoginRequiredMixin, DetailView):
    ...
    model = Event
    template_name = 'project/show_event_details.html'
...
def send_collab_invite(request, pk):
    ...
    return render(request, "project/collab_invite_form.html",
...
def send_event_invite(request, event_id):
    ...
    return render(request, "project/event_invite_form.html",
...
class InviteEventCollaboratorView(LoginRequiredMixin, View):
    ...
    """
    template_name = "project/invite_event_collaborator.html"
